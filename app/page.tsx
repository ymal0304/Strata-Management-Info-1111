    ...
    <div className="space-y-8">
      ...
      <section className="bg-gray-50 p-8 rounded-lg">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <a href="/committee" className="p-4 bg-white rounded-lg shadow hover:shadow-md transition">
            Committee Portal
          </a>
          <a href="/finances" className="p-4 bg-white rounded-lg shadow hover:shadow-md transition">
            Financial Reports
          </a>
          <a href="/maintenance" className="p-4 bg-white rounded-lg shadow hover:shadow-md transition">
            Maintenance Requests
          </a>
          <a href="/documents" className="p-4 bg-white rounded-lg shadow hover:shadow-md transition">
            Important Documents
          </a>
        </div>
      </section>
